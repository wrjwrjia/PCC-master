...
oCalendarChs.weekDaySting=new Array("SUN ","MON ","TUE ","WED ","THU ","FRI ","SAT ");
oCalendarChs.monthSting=new Array("JAU","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC");
oCalendarChs.oBtnTodayTitle="today";
oCalendarChs.oBtnCancelTitle="close";
oCalendarChs.oBtnCleanTitle="cls";
oCalendarChs.Init();
