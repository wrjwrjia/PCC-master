...
function initializeFolder(level, lastNode, leftSide)
{
	...
	if (level>0)
		if (lastNode)
		{
			this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='" + ImgDir + "mlastnode.gif'  align=left border=0 vspace=0 hspace=0 border=0>");
			leftSide = leftSide + "<img src='" + ImgDir + "blank.gif' align=left border=0 vspace=0 hspace=0>";
			this.isLastNode = 1;
		}else
		{
			this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='" + ImgDir + "mnode.gif'  align=left border=0 vspace=0 hspace=0 border=0>");
			leftSide = leftSide + "<img src='" + ImgDir + "vertline.gif'  align=left border=0 vspace=0 hspace=0>";
			this.isLastNode = 0;
		}
	else
		this.renderOb(auxEv);
...
function drawFolder(leftSide)
{
	...
	if(this.iconSrc=="desktop.gif")
		doc.write("src='" + ImgDir + this.iconSrc+"'   align=left border=0 vspace=0 hspace=0 border=0>");
	else
		doc.write("src='" + ImgDir + this.iconSrc+"'   align=left border=0 vspace=0 hspace=0 border=0>");
...
function initializeItem(level, lastNode, leftSide)
{
	...
	if (level>0)
		if (lastNode)
		{
			this.renderOb(leftSide + "<img src='" + ImgDir + "lastnode.gif' align=left border=0 vspace=0 hspace=0>");
			leftSide = leftSide + "<img src='" + ImgDir + "blank.gif'  align=left border=0 vspace=0 hspace=0>" ;
		}
		else
		{
			this.renderOb(leftSide + "<img src='" + ImgDir + "node.gif'  align=left border=0 vspace=0 hspace=0>");
			leftSide = leftSide + "<img src='" + ImgDir + "vertline.gif'  align=left border=0 vspace=0 hspace=0 align=left border=0 vspace=0 hspace=0>";
		}
	else
		this.renderOb("");
}
...
function drawItem(leftSide)
{
	...
	doc.write(" border=0 cellspacing=0 cellpadding=0>");
	doc.write("<tr height=top><td nowrap>");
	doc.write(leftSide);
...
function drawItem(leftSide)
{
	...
	doc.write("<tr valign=top><td nowrap>");
	doc.write(leftSide);
	//alert("<a href=" + this.link +' title=\"' + this.desc + '\">');
	if(browserVersion == 2)
	{
		doc.write("<layer id=showname bgcolor=#FFFFD2 visibility=hide>"+this.desc+"</layer>");
	}
