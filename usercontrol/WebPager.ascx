<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebPager.ascx.cs" Inherits="usercontrol_WebPager" %>
...
<asp:Label ID="lblCurpage" runat="server" Text="" ForeColor="red"></asp:Label> / <asp:Label ID="lblPages" runat="server" Text=""></asp:Label>　
    ...
    <asp:LinkButton ID="lnkbtnPrevious" CommandName="prev" OnClick="LinkButton_Click" runat="server">恢复</asp:LinkButton>&nbsp;&nbsp;
