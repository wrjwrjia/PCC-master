<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebPagerByIDForSearch.ascx.cs" Inherits="usercontrol_WebPagerByID" %>
...
<div style="width:99%;text-align:left;float:right" Class="paginator" >
    ...
    课程数:<asp:Label ID="lblCiTotal" runat="server" Text="" ForeColor="green" 
        Font-Bold="true" Font-Size="Small"></asp:Label>&nbsp; &nbsp; &nbsp; 教材数:<asp:Label 
        ID="lblBiTotal" runat="server" Text="" ForeColor="green" Font-Bold="true" 
        Font-Size="Small"></asp:Label>&nbsp;&nbsp; &nbsp; 状态数:<asp:Label ID="lblSiTotal" 
        runat="server" Text="" ForeColor="green" Font-Bold="true" Font-Size="Small"></asp:Label>
