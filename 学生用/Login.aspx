    ...
    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" valign="middle">
                <table width="508" height="277" border="0" cellpadding="0" cellspacing="0" background="Image/bg.jpg" style="margin-top:150px" >
                    <tr>
                                    ...
                                    <td width="64%" valign="top">
                                            <table border="0" cellspacing="2" cellpadding="2">
                                                <tr>
                                                    ...
                                                    <td>&nbsp;                                                        </td>
                                                    <td rowspan="2">
                                                        <asp:ImageButton ID="lbtLogin" runat="server" ImageUrl="Image/login04.gif"
