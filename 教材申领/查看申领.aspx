<%@ Page Language="C#" AutoEventWireup="true" CodeFile="查看申领.aspx.cs" Inherits="教材申领_查看申领" %>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0"  >
      ...
      <table cellpadding="1" cellspacing="1" class="tabGg" width="99%">
            ...
            <tr>
                ...
                <td  align="left" bgcolor="#FFFFFF" class="right_bg" >
                            <asp:TextBox ID="TBApplyTI" CssClass="input1" runat="server" Width="140px" ></asp:TextBox> 
                    </td>
                <td  bgcolor="#FFFFFF" class="style1">
                            ISBN：</td>
                <td  align="left" bgcolor="#FFFFFF" class="right_bg" >
            ...
            <tr>
                ...
                <td  align="left" bgcolor="#FFFFFF" class="right_bg">
                            <asp:TextBox ID="TBApplyTN" CssClass="input1" runat="server" Width="140px" ></asp:TextBox> 
                            </td>
                <td  bgcolor="#FFFFFF" class="style1">
                            教材名称：</td>
                <td  align="left" bgcolor="#FFFFFF" class="right_bg">
            ...
            <tr>
                ...
                <td  bgcolor="#FFFFFF" class="style1">
                            出版社：</td>
                <td  align="left" bgcolor="#FFFFFF" class="right_bg">
                            <asp:TextBox ID="TBPressName" CssClass="input1" runat="server" Width="140px"></asp:TextBox> 
                            </td>
            </tr>
            <tr>
        ...
        <uc1:WebPager ID="WebPager1" DataId="GridView1" PageSize="15"  runat="server" />
                ...
                <tr>
                        ...
                        <th  bgcolor="#ffffff" class="style1">
                            申请人工号：</th>
                        <td align="left" bgcolor="#ffffff" class="right_bg">
                            <asp:TextBox ID="TBApTeacherId" CssClass="input1" runat="server"  
                                ReadOnly="True" ></asp:TextBox> 
                            </td>
                        </tr>
                        <tr>
                        <th  bgcolor="#ffffff" class="style1">
                            申请人姓名：</th>
                        <td align="left" bgcolor="#ffffff" class="right_bg">
                            <asp:TextBox ID="TBApTeacherName" CssClass="input1" runat="server" 
                                ReadOnly="True" ></asp:TextBox> 
                            </td>
                        </tr>
                        <tr>
